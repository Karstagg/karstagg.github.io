...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Create_language_info_consonants_morpheme_initial</title>
	...
	<div class="tooltip">Help
		<span class="tooltiptext">
			<p>This allows the user to select items that they do not wish to be at the beginning of a morpheme.</p>
			<p>No morphemes can begin with any single character that you select here. They can still begin with any clusters that you have defined.</p>
	...
	<br>
	<form id="info_form" name="info_form" action="../processing/process_lang_info_7.php" method="post">
	<div id="text_div" style="font-size:80%">
        
		
		
		<p style="font-size:120%">Choose <span style="color:red">forbidden</span> morpheme <span style="color:red">initial</span> phonemes</p>
		<br>
	</div>
