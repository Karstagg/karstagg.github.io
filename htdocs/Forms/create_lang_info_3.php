...
<html>
	...
	<div class="tooltip">Help
		<span class="tooltiptext">
			<p>This form allows you to select the consonants that you would like to see appear at the onset of syllables. 
			Select all that you would like to see appear in a syllable onset position.</p>
		</span>
	</div>
	<form id="info_form" name="info_form" action="../processing/process_lang_info_3.php" method="post">
	<div id="text_div" style="font-size:80%">
        
		
		
		<p style="font-size:120%">Choose <span style="color:red">allowed</span> syllable <span style="color:red">onset</span> single consonants</p>
		<br>
	</div>
